<template>
        ...
        >
          <div style="padding-top: 10px">
            ...
            <el-form-item label="用户名" prop="username">
              <el-col :span="10">
                <el-input v-model="ruleForm.username" type="string" />
              </el-col>
            </el-form-item>
  ...
  <script>
  import { getEmailCode, register,getCaptcha } from '@/api/register'
    ...
    methods: {
      sendMsg: function() {
        ...
        if (!emailPass) {
          ...
          getCaptcha(self.ruleForm.email).then(res => {
            this.$message({
              showClose: true,
      ...
      register: function() {
        this.$refs['ruleForm'].validate((valid) => {
          if (valid) {
            ...
            register(this.ruleForm.username,this.ruleForm.pwd,this.ruleForm.cpwd, this.ruleForm.email,this.ruleForm.code,).then(res => {
              this.$message({
                showClose: true,
